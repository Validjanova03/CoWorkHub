...
class DBHelper {
  ...
  ''');
    ...
    // Workspaces
    await db.insert('resources', {'name': 'Hot Desk A1','resource_type': 'Workspace','availability_status': 'Available','unit_type': 'Hour','rate': 15});
    await db.insert('resources', {'name': 'Hot Desk A2','resource_type': 'Workspace','availability_status': 'Available','unit_type': 'Hour','rate': 15});
    await db.insert('resources', {'name': 'Dedicated Desk D1','resource_type': 'Workspace','availability_status': 'Available','unit_type': 'Hour','rate': 25});
    await db.insert('resources', {'name': 'Meeting Room M1','resource_type': 'Workspace','availability_status': 'Available','unit_type': 'Hour','rate': 50});
    await db.insert('resources', {'name': 'Conference Room C1','resource_type': 'Workspace','availability_status': 'Available','unit_type': 'Hour','rate': 120});

// Amenities
    await db.insert('resources', {'name': 'Color Printer','resource_type': 'Amenity','availability_status': 'Available','unit_type': 'Page','rate': 0.25});
    await db.insert('resources', {'name': '4K Projector','resource_type': 'Amenity','availability_status': 'Available','unit_type': 'Hour','rate': 20});
    await db.insert('resources', {'name': 'Coffee Machine','resource_type': 'Amenity','availability_status': 'Available','unit_type': 'Unit','rate': 3});
    await db.insert('resources', {'name': 'Locker Medium','resource_type': 'Amenity','availability_status': 'Available','unit_type': 'Hour','rate': 5});

    await db.insert('workspace', {'resource_id': 1, 'space_type': 'Hot Desk', 'capacity': 1});
    await db.insert('workspace', {'resource_id': 2, 'space_type': 'Hot Desk', 'capacity': 1});
    await db.insert('workspace', {'resource_id': 3, 'space_type': 'Dedicated Desk', 'capacity': 1});
    await db.insert('workspace', {'resource_id': 4, 'space_type': 'Meeting Room', 'capacity': 6});
    await db.insert('workspace', {'resource_id': 5, 'space_type': 'Conference Hall', 'capacity': 30});
